    ...
    <section id="contact" className="py-24 border-t border-black/5 dark:border-white/5">
      <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="mailto:contact@bulentunalan.dev" className="px-6 py-3 rounded-xl bg-black text-white dark:bg-white dark:text-black text-sm font-medium shadow-soft">{t(lang,'contact_email')}</a>
          ...
          <a href="https://github.com" target="_blank" className="px-6 py-3 rounded-xl bg-black/5 dark:bg-white/10 text-sm font-medium">GitHub</a>
        </div>
      </div>
    </section>
  );
