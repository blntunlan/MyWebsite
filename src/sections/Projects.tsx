    ...
    <section id="projects" className="py-28">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {projects.map(p => (
            <a key={p.slug} href={p.link || '#'} className="group relative flex flex-col gap-4 p-5 rounded-2xl bg-white/60 dark:bg-base-900/60 backdrop-blur-md border border-black/10 dark:border-white/10 shadow-soft hover:shadow-lg transition-shadow">
